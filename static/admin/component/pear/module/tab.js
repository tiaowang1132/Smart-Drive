layui.define(['jquery', 'element'], function(exports) {
	...
	pearTab.prototype.render = function(opt) {
		...
		$("body .layui-tab[lay-filter='" + option.elem + "'] .layui-tab-title").on("contextmenu", "li", function(e) {
			...
			var menu = "<ul><li class='item' id='" + option.elem + "closeThis'>Close Current</li><li class='item' id='" + option.elem +
				"closeOther'>Close Other</li><li class='item' id='" + option.elem + "closeAll'>Close All</li></ul>";
